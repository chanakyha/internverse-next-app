...
const sampleData = [
    {
        ...
        content: "Report bugs and issues in our newly launched testnet platform for crypto trading. ",
        points: "100 USDT",
        state: "🌎",
        days:"in 14 days"
    },
    ...
    },
    {
        ...
        image: "companyImage.png",
        content:
            "Make memes on NFTs and post them on Twitter. ",
        points: "50 USDC",
        state: "🌎",
        days:"in 3 days"
    },
    ...
    },
    {
        ...
        image: "companyImage.png",
        content:
            "Make recap threads for The Merge Twitter Space series",
        points: "20 USDC",
        state: "🌎",
        days:"in 12 days"
    },
    {
        ...
        image: "companyImage.png",
        content: "Use your creative skills to create fun and informative memes on Bricks Protocol.",
        points: "50 MATIC",
        state: "🎥",
        days:"in 7 days"
    },
    ...
    },
    {
        ...
        image: "companyImage.png",
        content:
            "Research and write on select monthly project.",
        points: "163 GCR",
        state: "✍️",
        days: "in 10 days"
    },
    ...
    },
    {
        title: "Dexe Network",
        image: "companyImage.png",
        content: "Submit a DeXe Improvement Proposal (DIP) to the DeXe Network Governance Forum",
        points: "75 DEXE",
        state: "🧑‍🔬",
        days:"in 11 days"
    },
...
const styles = {
    ...
    search:
        "text-[#6E4ABD] bg-[#D8C1FC] text-lg flex mt-[3%] items-center px-3 w-[90%] rounded-lg",
    searchBar:
        "bg-[#D8C1FC] p-2 pb-2.5  placeholder-[#6E4ABD] w-[80%]"    
};
        ...
        <div className={styles.wrapper}>
            ...
            <div className={styles.tabs}>
                <button
                    ...
                    style={{ fontFamily: "PilatExtended" }}
                    className={`text-xl ${activeTab == "all"
            ...
            <div className={styles.search}>
                ...
                <input type='text' placeholder='Search contests' className={styles.searchBar}/>
            </div>
